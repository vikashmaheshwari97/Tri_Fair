"""MO-CAPO-style curated figures for Bias in Bios / Qwen-3-30B / Tri-Fair.
...
Terminology:
  - User-facing plots use Accuracy / Test Macro-F1, not quality.
...
def output_dir() -> Path:
    out = Path("analysis/output/curated_figures_bias_mocapo_style")
...
def write_readme(outdir: Path) -> None:
    readme = """# Bias in Bios / Qwen-3-30B 1M curated figures
