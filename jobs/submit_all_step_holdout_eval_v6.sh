...
tf_log "All-step v6 holdout: actual_tokens=$MIN_ACTUAL_TOKENS..$MAX_ACTUAL_TOKENS"
job_id="$(sbatch "${SBATCH_ARGS[@]}" jobs/all_step_holdout_eval_v6.sbatch)"
tf_log "Submitted v6 all-step holdout array $job_id ($array_spec)"
