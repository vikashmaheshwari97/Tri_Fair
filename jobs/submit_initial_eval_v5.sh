#!/usr/bin/env bash
# Submit the separate Initial Instructions evaluation for the shared v5 pool.
...
job_id="$(sbatch "${SBATCH_ARGS[@]}" jobs/initial_eval_v5.sbatch)"
tf_log "Submitted v5 initial-pool evaluation array $job_id ($array_spec)"
